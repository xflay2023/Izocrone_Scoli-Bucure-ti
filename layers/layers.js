...
lyr_Circumscriptii_2.set('fieldLabels', {'fid': 'hidden field', 'Trup': 'hidden field', 'Denumire': 'inline label - always visible', 'Nr_Schimbu': 'hidden field', 'Schimb_1': 'hidden field', 'Schimb_2': 'hidden field', 'Schimb_3': 'hidden field', 'Nr_săli_o': 'hidden field', 'Laboratoar': 'hidden field', 'Săli_clas': 'hidden field', 'Personal_c': 'hidden field', 'Personal_n': 'hidden field', 'Personal_1': 'hidden field', 'Sector': 'hidden field', 'Adrese_Lim': 'hidden field', 'Cod_SIIIR': 'inline label - always visible', 'Observați': 'hidden field', 'Autor': 'hidden field', 'Dată_crea': 'hidden field', });
...
lyr_Unitidenvmnt_6.set('fieldLabels', {'POINT_X': 'hidden field', 'POINT_Y': 'hidden field', 'CF': 'no label', 'SIIIR': 'inline label - always visible', 'Statutul': 'no label', 'Unit_înv': 'inline label - always visible', 'Observ': 'no label', 'Tip_unit': 'inline label - always visible', 'Coduri': 'inline label - always visible', 'Creșă': 'hidden field', 'Preșcolar': 'hidden field', 'Primar': 'hidden field', 'Gimnazial': 'hidden field', 'Liceal': 'hidden field', 'Vocaționa': 'hidden field', 'Profes': 'hidden field', 'Postliceal': 'hidden field', 'Uni': 'hidden field', 'Special': 'hidden field', 'Club': 'hidden field', 'Adresă': 'no label', 'Cod_poșta': 'no label', 'Localitate': 'no label', 'Sector': 'no label', 'E_mail': 'no label', 'Website': 'no label', 'Telefon': 'no label', 'Tip_propri': 'no label', 'Nr_elevi': 'no label', 'Schimbul_1': 'no label', 'Schimbul_2': 'no label', 'Schimbul_3': 'no label', 'Mod_funcț': 'inline label - always visible', 'Nr_schimb': 'hidden field', 'Săli_clas': 'hidden field', 'Laborat': 'hidden field', 'Sală_mese': 'hidden field', 'Biblio': 'hidden field', 'Cămin': 'hidden field', 'Sală_spor': 'hidden field', 'Teren_ext': 'hidden field', 'Bazin_îno': 'hidden field', 'Atelier': 'hidden field', 'Cab_medic': 'hidden field', 'Total_săl': 'hidden field', 'Pers_cali': 'hidden field', 'Pers_necal': 'hidden field', 'Pers_neces': 'hidden field', 'Sursă_inf': 'inline label - always visible', 'Data_recep': 'inline label - always visible', 'Autor': 'inline label - always visible', 'circumsc �': 'hidden field', 'id': 'hidden field', });
